...
* Utility Functions
First off, let's not have emacs warn us about disabled commands.
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  (use-package nord-theme
    :load-path "themes"
    :config
    (add-to-list 'custom-safe-themes "82358261c32ebedfee2ca0f87299f74008a2e5ba5c502bde7aaa15db20ee3731")
    (load-theme 'nord t))
#+end_src
...
Let's not have any visual or auditory indication of errors; it actually slows
down processing.
#+begin_src emacs-lisp
